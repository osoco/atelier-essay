...
\maketitle
\doistamp
\blfootnote{Este trabajo se distribuye bajo una licencia Creative Commons
Atribución-NoComercial-CompartirIgual 4.0 Internacional (CC BY-NC-SA 4.0):
\url{https://creativecommons.org/licenses/by-nc-sa/4.0/}}

\begin{abstract}
Continuando la visión sobre el diseño de software esbozada en el ensayo previo de Petricek~\cite{petricek}, estas actas ficticias relatan la visita de un comité de ingenieros y
...
---Bienvenidos ---dijo---. Soy \href{https://es.wikipedia.org/wiki/Adele_Goldberg}{Adele} \href{https://es.wikipedia.org/wiki/Douglas_Engelbart}{Engelbart}.
